...
{
    partial class HasUnlockedSection : UserControl, ICodeComponent
    {
        public HasUnlockedSection()
        {
            InitializeComponent();
        ...
        {
            var result = code.Substring("HasUnlockedSection(".Length, code.LastIndexOf(')') - "HasUnlockedSection(".Length);
        ...
        {
            return string.Format("HasUnlockedSection({0})", Globals.Sections[cmbSections.SelectedIndex].ID);
        }
