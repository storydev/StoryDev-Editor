...
{
    partial class HideCharacterGossip : UserControl, ICodeComponent
    {
        public HideCharacterGossip()
        {
            InitializeComponent();
        ...
        {
            var result = code.Substring("HideCharacterGossip(".Length, code.LastIndexOf(')') - "HideCharacterGossip(".Length);
        ...
        {
            return string.Format("HideCharacterGossip({0})", Globals.Gossips[cmbGossips.SelectedIndex].ID);
        }
