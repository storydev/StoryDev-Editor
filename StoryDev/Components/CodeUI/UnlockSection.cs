...
{
    partial class UnlockSection : UserControl, ICodeComponent
    {
        ...
        {
            var result = code.Substring("UnlockSection(".Length, code.LastIndexOf(')') - "UnlockSection(".Length);
        ...
        {
            return string.Format("UnlockSection({0})", Globals.Sections[cmbSections.SelectedIndex].ID);
        }
