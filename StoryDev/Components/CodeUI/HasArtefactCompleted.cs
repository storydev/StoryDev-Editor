...
{
    partial class HasArtefactCompleted : UserControl, ICodeComponent
    {
        public HasArtefactCompleted()
        {
            InitializeComponent();
        ...
        {
            var result = code.Substring("HasArtefactCompleted(".Length, code.LastIndexOf(')') - "HasArtefactCompleted(".Length);
        ...
        {
            return string.Format("HasArtefactCompleted({0})", Globals.Artefacts[cmbArtefacts.SelectedIndex].ID);
        }
