...
{
    partial class UnlockJournal : UserControl, ICodeComponent
    {
        public UnlockJournal()
        {
            InitializeComponent();
        ...
        {
            var result = code.Substring("UnlockJournal(".Length, code.LastIndexOf(')') - "UnlockJournal(".Length);
        ...
        {
            return string.Format("UnlockJournal({0})", Globals.Journals[cmbJournals.SelectedIndex].ID);
        }
