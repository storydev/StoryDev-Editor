...
{
    partial class IsWithinSection : UserControl, ICodeComponent
    {
        public IsWithinSection()
        {
            InitializeComponent();
        ...
        {
            var result = code.Substring("IsWithinSection(".Length, code.LastIndexOf(')') - "IsWithinSection(".Length);
        ...
        {
            return string.Format("IsWithinSection({0})", Globals.Sections[cmbSections.SelectedIndex].ID);
        }
