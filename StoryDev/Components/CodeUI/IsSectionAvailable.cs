...
{
    partial class IsSectionAvailable : UserControl, ICodeComponent
    {
        ...
        {
            var result = code.Substring("IsSectionAvailable(".Length, code.LastIndexOf(')') - "IsSectionAvailable(".Length);
