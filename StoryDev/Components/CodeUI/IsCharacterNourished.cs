...
{
    partial class IsCharacterNourished : UserControl, ICodeComponent
    {

        private IEnumerable<Character> chars;

        public IsCharacterNourished()
        {
            InitializeComponent();
        ...
        {
            return string.Format("IsCharacterNourished({0})", chars.ElementAt(cmbCharacters.SelectedIndex).ID);
        }
    }
}
